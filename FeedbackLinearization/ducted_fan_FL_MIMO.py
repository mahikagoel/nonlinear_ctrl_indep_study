...
## dual column g matrix help
f = sym.Matrix([xdot, 0, ydot, -g, thetadot, 0])
g_v = sym.Matrix([[0, 0], [sym.cos(theta)/m, -sym.sin(theta)/m], [0, 0], [sym.sin(theta)/m, sym.cos(theta)/m], [0, 0], [r/J, 0]])
print(f.jacobian(states))
